...
class Post {
    ...
    WHERE
        archivos.rol = 1 AND posts.idioma = '".$_SESSION["idioma"]."' AND posts.seo_keywords LIKE '%{$where}%'
    ORDER BY
        posts.id_post
    DESC";
    ...
    public function listarPosts($categoria) {
        ...
        switch ($categoria) {
            ...
            case "inicio":
                ...
                break;
            case "acuerdo":
                $strsql = "SELECT posts.id_post, usuarios.nombre, usuarios.apellidoP, usuarios.apellidoM, posts.nom_post, posts.descripcion_corta, categorias.nom_categoria, posts.activo, archivos.nom_file, posts.seo_keywords FROM posts INNER JOIN usuarios ON posts.id_usuario = usuarios.id_usuario INNER JOIN categorias ON posts.id_categoria = categorias.id_categoria INNER JOIN archivos ON posts.id_post = archivos.id_post WHERE posts.id_categoria=1 AND archivos.rol=1 AND posts.idioma='".$_SESSION["idioma"]."' AND posts.activo=1 ORDER BY posts.id_post";
                break;
            case "eventos":
            ...
            case "infografias":
                ...
                break;
            case "documentos":
                $strsql = "SELECT posts.id_post, usuarios.nombre, usuarios.apellidoP, usuarios.apellidoM, posts.nom_post, posts.descripcion_corta, categorias.nom_categoria, posts.activo, archivos.nom_file FROM posts INNER JOIN usuarios ON posts.id_usuario = usuarios.id_usuario INNER JOIN categorias ON posts.id_categoria = categorias.id_categoria INNER JOIN archivos ON posts.id_post = archivos.id_post WHERE posts.id_categoria=6 AND archivos.rol=1  AND posts.idioma='".$_SESSION["idioma"]."' AND posts.activo=1 ORDER BY posts.id_post";
                break;
            case "audios":
                $strsql = "SELECT posts.id_post, usuarios.nombre, usuarios.apellidoP, usuarios.apellidoM, posts.nom_post, posts.descripcion_corta, categorias.nom_categoria, posts.activo, archivos.nom_file FROM posts INNER JOIN usuarios ON posts.id_usuario = usuarios.id_usuario INNER JOIN categorias ON posts.id_categoria = categorias.id_categoria INNER JOIN archivos ON posts.id_post = archivos.id_post WHERE posts.id_categoria=7 AND archivos.rol=1  AND posts.idioma='".$_SESSION["idioma"]."' AND posts.activo=1 ORDER BY posts.id_post";
                break;
            case "videos":
                $strsql = "SELECT posts.id_post, usuarios.nombre, usuarios.apellidoP, usuarios.apellidoM, posts.nom_post, posts.descripcion_corta, categorias.nom_categoria, posts.activo, archivos.nom_file FROM posts INNER JOIN usuarios ON posts.id_usuario = usuarios.id_usuario INNER JOIN categorias ON posts.id_categoria = categorias.id_categoria INNER JOIN archivos ON posts.id_post = archivos.id_post WHERE posts.id_categoria=8 AND archivos.rol=1  AND posts.idioma='".$_SESSION["idioma"]."' AND posts.activo=1 ORDER BY posts.id_post";
                break;            
            case "enlaces":
